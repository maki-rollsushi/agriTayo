    ...
    products: [
      {
        ...
        pricePerKg: 25,
        description:
          "Glutinous white corn often grown in upland areas of Albay.",
        imageUrl:
          "https://upload.wikimedia.org/wikipedia/commons/4/48/9698Cuisine_foods_in_Bulacan_55.jpg",
      },
      {
        name: "Rice",
        variety: "IR64",
        ...
        pricePerKg: 40,
        description:
          "High-yielding rice variety popular in Albay with soft grains and good aroma.",
        imageUrl:
          "https://www.bigas-online.com/cdn/shop/products/well-milledrice_1024x1024@2x.jpg?v=1600423751",
      },
      {
        name: "Coconut",
        variety: "Dwarf",
      ...
      },
      {
        ...
        pricePerKg: 75,
        description:
          "Fiber crop used in handicrafts and ropes, native to the region.",
        imageUrl: "https://m.media-amazon.com/images/I/91Q5aUMp+7L.jpg",
      },
      {
        name: "Banana",
    ...
    products: [
      {
        ...
        pricePerKg: 38,
        description:
          "Widely grown variety in Sorsogon, known for resilience to pests.",
        imageUrl:
          "https://www.bigas-online.com/cdn/shop/products/well-milledrice_1024x1024@2x.jpg",
      },
      {
        name: "Taro",
        variety: "Gabi",
    ...
    products: [
      {
        ...
        pricePerKg: 14,
        description:
          "Traditional coconut variety used in cooking oil production.",
        imageUrl: "https://m.media-amazon.com/images/I/91Q5aUMp+7L.jpg",
      },
      {
        name: "Peanut",
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        pricePerKg: 24,
        description:
          "Used in grilled dishes and pickles, thrives in volcanic soil.",
        imageUrl: "https://m.media-amazon.com/images/I/91Q5aUMp+7L.jpg",
      },
    ],
  },
