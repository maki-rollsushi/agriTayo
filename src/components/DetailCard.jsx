      ...
      <div className="product-card-large-horizontal">
        ...
        <div className="product-info-block">
          ...
          <div className="product-details">
            <div><strong>Variety:</strong> {product.variety}</div>
            <div><strong>Max Quantity:</strong> {product.maxQuantityKg} kg</div>
            <div><strong>Grow Time:</strong> {product.growTimeDays} days</div>
            <div><strong>Price per KG:</strong> ₱{product.pricePerKg}</div>
          </div>
